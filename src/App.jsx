...
function getEmpty() {
  return {
    salas: [], profissionais: [], pacientes: [], sessoes: [],
    especialidades: ["Fonoaudiologia","Fisioterapia","Terapia Ocupacional","Psicologia","Psicopedagogia","Musicoterapia","Neuropsicologia"],
    tratamentos: [
      ...
      {id:"t4",nome:"Psicoterapia",especialidades:["Psicologia"]},
...
function App() {
  ...
  useEffect(function() { ldDB().then(function(d) { if(d) { var merged = Object.assign({},getEmpty(),d); if(!merged.sessoes) merged.sessoes=[]; if(!merged.tratamentos) merged.tratamentos=getEmpty().tratamentos; if(!merged.especialidades) merged.especialidades=getEmpty().especialidades; setData(merged); } setLoading(false); }); }, []);
    ...
    return React.createElement("div",null,
      React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}},
        ...
        React.createElement("div",{style:{display:"flex",gap:8}},
          ...
          React.createElement(Btn,{v:"pri",onClick:function(){setEdit({nome:"",nivel:"Nível 1",obs:"",prios:["","",""]});setModal("pac")}},"+ Paciente")
        )
      ),
      ...
      :React.createElement("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(300px,1fr))",gap:14}},
        fil.map(function(pac){
          ...
          return React.createElement(Crd,{key:pac.id,style:{cursor:"pointer"},onClick:function(){setEdit(Object.assign({},pac,{prios:(pac.prios||["","",""]).slice()}));setModal("pac")}},
